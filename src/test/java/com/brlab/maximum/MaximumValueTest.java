...
class MaximumValueTest {
    ...
    void findMaxFloatTestThirdPosition(){
        ...
        Assertions.assertEquals(200.0f,MaximumValue.findMaxFloat(10.0f,90.0f,200.0f),"Test case failed because the excpected output is 200.0");

    }
    @Test
    void findMaxStringTestFirstPosition(){
        Assertions.assertEquals(200.0f,MaximumValue.findMaxString("Yogesh","Rohan","Vinay"),"Test case failed because the excpected output is Yogesh");
    }
    @Test
